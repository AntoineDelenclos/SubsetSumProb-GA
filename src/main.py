...
def main():
    ...
    smallSolutions, smallNumberTreatments = folderSolutions("/home/antoine/PycharmProjects/SubsetSumProb-GA/data/small", POPULATION_NUMBER, POPULATION_VALUE_IS_1_PERCENTAGE, PERCENT_POP_MUTATED, LOW_PERCENT_GENES_MUTATED, HIGH_PERCENT_GENES_MUTATED, PERCENT_POP_CROSSING, LOW_PERCENT_CUT_NUMBER, HIGH_PERCENT_CUT_NUMBER, BEST_POP_LENGTH, NEW_FULLY_RANDOM_POP_LENGTH, WORST_POP_LENGTH, PENALTY, CPU_CORES)
    print(f"smallSolutions : {smallSolutions}\n smallNumberTreatments : {smallNumberTreatments}")

    mediumSolutions, mediumNumberTreatments= folderSolutions("/home/antoine/PycharmProjects/SubsetSumProb-GA/data/medium", POPULATION_NUMBER, POPULATION_VALUE_IS_1_PERCENTAGE, PERCENT_POP_MUTATED, LOW_PERCENT_GENES_MUTATED, HIGH_PERCENT_GENES_MUTATED, PERCENT_POP_CROSSING, LOW_PERCENT_CUT_NUMBER, HIGH_PERCENT_CUT_NUMBER, BEST_POP_LENGTH, NEW_FULLY_RANDOM_POP_LENGTH, WORST_POP_LENGTH, PENALTY, CPU_CORES)
    print(f"mediumSolutions : {mediumSolutions}\n mediumNumberTreatments : {mediumNumberTreatments}")

    largeSolutions, largeNumberTreatments = folderSolutions("/home/antoine/PycharmProjects/SubsetSumProb-GA/data/large", POPULATION_NUMBER, POPULATION_VALUE_IS_1_PERCENTAGE, PERCENT_POP_MUTATED, LOW_PERCENT_GENES_MUTATED, HIGH_PERCENT_GENES_MUTATED, PERCENT_POP_CROSSING, LOW_PERCENT_CUT_NUMBER, HIGH_PERCENT_CUT_NUMBER, BEST_POP_LENGTH, NEW_FULLY_RANDOM_POP_LENGTH, WORST_POP_LENGTH, PENALTY, CPU_CORES)
    print(f"largeSolutions : {largeSolutions}\n largeNumberTreatments : {largeNumberTreatments}")

    xlargeSolutions, xlargeNumberTreatments = folderSolutions("/home/antoine/PycharmProjects/SubsetSumProb-GA/data/xlarge", POPULATION_NUMBER, POPULATION_VALUE_IS_1_PERCENTAGE, PERCENT_POP_MUTATED, LOW_PERCENT_GENES_MUTATED, HIGH_PERCENT_GENES_MUTATED, PERCENT_POP_CROSSING, LOW_PERCENT_CUT_NUMBER, HIGH_PERCENT_CUT_NUMBER, BEST_POP_LENGTH, NEW_FULLY_RANDOM_POP_LENGTH, WORST_POP_LENGTH, PENALTY, CPU_CORES)
    print(f"xlargeSolutions : {xlargeSolutions}\n xlargeNumberTreatments : {xlargeNumberTreatments}")
